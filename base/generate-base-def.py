...
assignments = [
    ...
    [Statement.SIMPLE_STR, "TOPIC_SCAN_SSDP", "net.scan.ssdp"],
    ...
    [Statement.SIMPLE_PORT, "SCAND_SSDP_PROMETHEUS_PORT", 3209],
    ...
    [Statement.SIMPLE_PORT, "CLRPCD_SSDP_PROMETHEUS_PORT", 3300],
    [Statement.SECTION, ")"],
